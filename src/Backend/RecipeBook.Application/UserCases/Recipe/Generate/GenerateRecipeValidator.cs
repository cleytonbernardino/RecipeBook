...
namespace RecipeBook.Application.UserCases.Recipe.Generate
{
    public class GenerateRecipeValidator : AbstractValidator<RequestGenerateRecipeJson>
    {
        ...
        {
            const int maximum_number_ingredients = RecipeBookRuleConstants.MAXIMUM_INGREDIENTS_GENERATE_RECIPE;
            ...
            RuleFor(request => request.Ingredients)
                ...
                .WithMessage(ResourceMessagesException.DUPLICATE_INGREDIENT_IN_LIST);
